            ...
            def logger_workload():
                try:
                    try:
                        ...
                        for i in range(500):
                            logger.log_error(
                                f"PERF_TEST_{i}", f"Performance test error {i}"
                            )
                            if i % 100 == 0:
    ...
    def benchmark_system_stress(self) -> Dict[str, any]:
        ...
        try:
            ...
            return {
                ...
                "thermal_throttling_detected": self._detect_thermal_throttling(
                    stress_results
                ),
            ...
            return {"component": "system_stress", "error": str(e), "status": "failed"}
    ...
    def run_comprehensive_benchmark(self) -> Dict[str, any]:
        ...
        results = {
            ...
            "summary": {
                ...
                "thermal_throttling_detected": benchmarks.get("system_stress", {}).get(
...
def main():
    ...
    print(
        f"   CPU: {cpu_info['physical_cores']} cores ({cpu_info['logical_cores']} logical)"
    )
