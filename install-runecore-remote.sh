...
# Or: curl -sSL https://raw.githubusercontent.com/datamann1013/RuneCore_Ecosystem/main/install-runecore-remote.sh | bash -s -- --version=AI_service
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  curl -sSL $RAW_URL/main/install-runecore-remote.sh | bash -s -- --version=AI_service"
            echo ""
